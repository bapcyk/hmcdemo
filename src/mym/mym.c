 ...
 * Gavin Bell
 *
 * XXX: trackball code was removed by me
 */
#include <math.h>
...
void
euler_to_quat(double h, double p, double r, double q[4])
{
        double sinp, sinh, sinr, cosp, cosh, cosr;
	...
	q[0] = sinr * cosp * cosh - cosr * sinp * sinh;
	q[1] = cosr * sinp * cosh + sinr * cosp * sinh;
	q[2] = cosr * cosp * sinh - sinr * sinp * cosh;
	q[3] = cosr * cosp * cosh + sinr * sinp * sinh;
...
void
add_quats(double q1[4], double q2[4], double dest[4], int *count)
{
