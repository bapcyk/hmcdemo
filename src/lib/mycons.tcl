...
package provide mycons 1.0
namespace eval ::mycons {}

# puts into console
# FIXME doesnot see ::sensor variable
proc ::mycons::ConsolePuts {consname args} {
    interp eval "interp$consname" [list puts {*}$args]
}

proc ::mycons::ConsoleEval {consname body} {
    interp eval "interp$consname" $body
}

proc ::mycons::ConsoleInit {{parent {}} {name ::console}} {
    #####
    #
    # "console for Unix"
    ...
    set consoleInterp [interp create interp$name]
    ...
    proc ::consoleinterp {sub cmd} {
        ...
        proc ::exit {{errno 0}} {
            # FIXME call application handler of exit
            destroy .
            ::tcl_exit $errno
        }
        $consoleInterp alias puts puts
        $consoleInterp alias exit exit; # XXX no matters!!!
        # }}}
